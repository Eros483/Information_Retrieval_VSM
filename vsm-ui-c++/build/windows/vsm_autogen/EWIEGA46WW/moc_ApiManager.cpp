...
void ApiManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ApiManager::*)(const QJsonDocument & )>(_a, &ApiManager::apiResponse, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ApiManager::*)(const QString & )>(_a, &ApiManager::apiError, 1))
            return;
    }
}
